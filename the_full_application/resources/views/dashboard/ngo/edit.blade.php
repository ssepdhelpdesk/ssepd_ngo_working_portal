         ...
         <div class="card">
            <div class="card-body">
               ...
               <ul class="nav nav-tabs customtab2" role="tablist">
                  ...
                  <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#part3" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down">Messages</span></a> </li>
               </ul>
               <!-- Tab panes -->
               ...
               <div class="tab-pane p-20" id="part3" role="tabpanel">3</div>
            </div>
         </div>
      </div>
   </div>
