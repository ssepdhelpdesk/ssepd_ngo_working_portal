      ...
      $("#office_bearer_pan").blur(function () {
         ...
         $.get("{{ route('admin.ngo.check_pan_no_of_office_bearer') }}", {
            ...
            if (data == 0) {
               ...
               $('#check_office_bearer_pan').html('<span style="color:#FF0000">This PAN No is already registered with yor NGO.</span>');
      ...
      $("#office_bearer_aadhar").blur(function () {
         ...
         $.get("{{ route('admin.ngo.check_aadhar_no_of_office_bearer') }}", {
            ...
            if (data == 0) {
               ...
               $('#check_office_bearer_aadhar').html('<span style="color:#FF0000">This Aadhar No is already registered with yor NGO.</span>');
